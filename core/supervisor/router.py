...
#                 rows away and, worse, can silently alter financial numbers.
...
# [WRITE_DONE]/[SHEET_DONE] are terse status lines with no rich data to lose, so
# those keep the friendly LLM rephrase via _emit_final_reply.
_PASSTHROUGH_MARKERS = ("[READ_DONE]", "[CLARIFY]")
